...
public class ReferenceQueryServiceH2Test {
    ...
    public void testUpdateRefTable() {
        ReferenceTable  result = refQueryRepository.saveRefTable("223355-6667", ref);
        assertNotNull(result);
        ...
        ReferenceTable refResult = refQueryRepository.updateRefTable("223355-6667", ref2);
    ...
    public void testGetAllReferences() {
        ReferenceTable  result = refQueryRepository.saveRefTable("223355-66669", ref);
        assertNotNull(result);
