...
public class RefValueIdDeleteHandler implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        CompletableFuture<String> result = service.removeRefValue(id).thenApply((e) -> {
            String m =  "Deleted reference Value: " + id;
            return m;
        });
