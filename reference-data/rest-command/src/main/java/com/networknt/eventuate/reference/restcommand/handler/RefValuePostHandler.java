...
public class RefValuePostHandler implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        CompletableFuture<ReferenceValue> result = service.addRefValue(referenceValue.getTableId(), referenceValue).thenApply((e) -> {
